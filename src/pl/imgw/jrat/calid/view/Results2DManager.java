...
import pl.imgw.jrat.data.IntArray;
...
public class Results2DManager {
    ...
    public Results2DManager(ArrayList<PairedPoint> array, PolarVolumesPair pair) {
        ...
        Iterator<PairedPoint> itr = array.iterator();
        while (itr.hasNext()) {
            PairedPoint pp = itr.next();
