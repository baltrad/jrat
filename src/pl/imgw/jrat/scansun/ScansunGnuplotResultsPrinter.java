...
import pl.imgw.jrat.scansun.ScansunConstants.EventType;
...
public class ScansunGnuplotResultsPrinter extends ScansunResultsPrinter {
    ...
    public void generatePlots() {
        ...
        try {
            ...
            log.printMsg("generatePlots error", Log.TYPE_ERROR,
                    Log.MODE_VERBOSE);
            return;
    ...
    private void generateScatterplot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: scatterplot for " + siteName,
    ...
    public void generateDetectionTimePlot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: time plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
    }
    ...
    public void generateDetectionElevationPlot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: elevation plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
    ...
    public void generateDetectionAzimuthPlot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: azimuth plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
    }
    ...
    public void generateDetectionPowerPlot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: power plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
    }
    ...
    public void generateCoefficientsPlots(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: ax plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
        ...
        log.printMsg("New plot generated: ay plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
        ...
        log.printMsg("New plot generated: bx plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
        ...
        log.printMsg("New plot generated: by plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
        ...
        log.printMsg("New plot generated: c plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
        ...
        log.printMsg("New plot generated: P0 plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
    ...
    public void generateSolarFluxPlot(String siteName, Set<File> files)
        ...
        log.printMsg("New plot generated: solar flux plot for " + siteName,
                Log.TYPE_NORMAL, Log.MODE_VERBOSE);
