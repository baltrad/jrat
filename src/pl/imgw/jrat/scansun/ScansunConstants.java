...
public class ScansunConstants {
	...
	public static final SimpleDateFormat SCANSUN_DATE_FORMAT = new SimpleDateFormat(
			"yyyyMMdd");
	public static final SimpleDateFormat SCANSUN_DATE_TIME_FORMAT = new SimpleDateFormat(
			"yyyy-MM-dd'" + SCANSUN_DATE_SEPARATOR + "'HH:mm");
	public static final SimpleDateFormat SCANSUN_DATE_TIME_FORMAT_LONG = new SimpleDateFormat(
			"yyyy-MM-dd'" + SCANSUN_DATE_SEPARATOR + "'HH:mm:ss");
	...
	public enum Sites {
		BRZUCHANIA(20.079720, 50.394170, 453.000000), GDANSK(18.456310,
				54.384250, 158.000000), LEGIONOWO(20.960630, 52.405220,
				119.000000), PASTEWNIK(16.039499, 50.891998, 688.000000), POZNAN(
				16.797060, 52.413260, 123.000000), RAMZA(18.726670, 50.151670,
				358.000000), RZESZOW(22.002501, 50.114170, 241.000000), SWIDWIN(
				15.831110, 53.790280, 146.000000);
